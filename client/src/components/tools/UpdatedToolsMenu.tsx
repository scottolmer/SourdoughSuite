...
import { Calculator, FileText, Clock, ChevronRight, Home } from 'lucide-react';
...
export default function UpdatedToolsMenu({ activeToolPath, showAllTools = true }: ToolMenuProps) {
  // All tools array
  const allTools = [
    {
